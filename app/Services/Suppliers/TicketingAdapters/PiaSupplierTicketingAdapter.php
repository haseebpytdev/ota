...
class PiaSupplierTicketingAdapter implements SupplierTicketingInterface
{
    public function issueTickets(Booking $booking, SupplierBooking $supplierBooking, User $actor): TicketingResultData
    {
        return new TicketingResultData(
            ...
            warnings: ['PIA ticketing is not implemented until ticketing API documentation is reviewed.'],
        );
    }
}
