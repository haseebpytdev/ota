            ...
            <div class="ota-hero-grid">
                <div>
                    ...
                    <div class="ota-hero-actions">
                        <a href="#ota-flight-search" class="ota-btn-white"><i class="fa fa-search"></i> Search Flights</a>
                        <a href="{{ route('agent.register') }}" class="ota-btn-ghost" title="Agents"><i class="fa fa-users"></i> Agents</a>
                    </div>
