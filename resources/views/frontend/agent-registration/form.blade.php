...
@section('content')
    ...
    <form method="POST" action="{{ route('agent.register.store') }}">
        ...
        <div class="ota-auth-group" style="margin-top:18px;">
            <h3 style="margin:0 0 10px;font-size:1rem;">1. Personal details</h3>
        ...
        <div class="ota-auth-group">
            <h3 style="margin:0 0 10px;font-size:1rem;">2. Business details</h3>
        ...
        <div class="ota-auth-group">
            <h3 style="margin:0 0 10px;font-size:1rem;">3. Verification details</h3>
        ...
        <div class="ota-auth-group">
            <h3 style="margin:0 0 10px;font-size:1rem;">4. Services and expected volume</h3>
        ...
        <div class="ota-auth-group">
            <h3 style="margin:0 0 10px;font-size:1rem;">5. Agreement</h3>
