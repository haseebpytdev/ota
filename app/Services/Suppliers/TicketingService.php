...
use App\Services\Suppliers\TicketingAdapters\MockSupplierTicketingAdapter;
...
class TicketingService
{
    public function __construct(
        ...
        protected MockSupplierTicketingAdapter $mockAdapter,
    ...
    public function isBookingEligibleForTicketing(Booking $booking): bool
    {
        ...
        return ($booking->pnr ?? '') !== '' || ($booking->supplier_reference ?? '') !== '';
    }
    ...
    public function issueTickets(Booking $booking, User $actor): TicketingResultData
    {
        ...
        if (! $this->isBookingEligibleForTicketing($booking)) {
            return new TicketingResultData(
                ...
                error_message: 'Booking is not eligible for ticketing.',
            );
        }
