			...
			<div class="container">
				...
				<div class="service-counter text-center">
					...
					<div class="col-md-4 col-sm-4">
						<div class="single-service-box">
							<div class="service-img">
								<img src="{{ $tournest }}/images/service/s1.png" alt="service-icon" />
							</div><!--/.service-img-->
					...
					<div class="col-md-4 col-sm-4">
						<div class="single-service-box">
							<div class="service-img">
								<img src="{{ $tournest }}/images/service/s2.png" alt="service-icon" />
							</div><!--/.service-img-->
							<div class="service-content">
								<h2>
									<a href="#">
					...
					<div class="col-md-4 col-sm-4">
						<div class="single-service-box">
							<div class="statistics-img">
								<img src="{{ $tournest }}/images/service/s3.png" alt="service-icon" />
							</div><!--/.service-img-->
							<div class="service-content">
						  		...
						  		<div class="row">
						  			...
						  			<div class="col-md-6">
						  				<div class="filtr-item">
											<img src="{{ $tournest }}/images/gallary/g1.jpg" alt="portfolio image"/>
						  			...
						  			<div class="col-md-6">
						  				<div class="filtr-item">
											<img src="{{ $tournest }}/images/gallary/g2.jpg" alt="portfolio image"/>
											<div class="item-title">
												<a href="#">
													venuzuala
												</a>
						  			...
						  			<div class="col-md-4">
						  				<div class="filtr-item">
											<img src="{{ $tournest }}/images/gallary/g3.jpg" alt="portfolio image"/>
											<div class="item-title">
												<a href="#">
													brazil
												</a>
						  			...
						  			<div class="col-md-4">
						  				<div class="filtr-item">
											<img src="{{ $tournest }}/images/gallary/g4.jpg" alt="portfolio image"/>
											<div class="item-title">
												<a href="#">
													australia 
												</a>
						  			...
						  			<div class="col-md-4">
						  				<div class="filtr-item">
											<img src="{{ $tournest }}/images/gallary/g5.jpg" alt="portfolio image"/>
											<div class="item-title">
												<a href="#">
													netharland
												</a>
						  			...
						  			<div class="col-md-8">
						  				<div class="filtr-item">
											<img src="{{ $tournest }}/images/gallary/g6.jpg" alt="portfolio image"/>
											<div class="item-title">
												<a href="#">
													turkey
												</a>
					...
					<div class="row">
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-package-item">
								<img src="{{ $tournest }}/images/packages/p1.jpg" alt="package-place">
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-package-item">
								<img src="{{ $tournest }}/images/packages/p2.jpg" alt="package-place">
								<div class="single-package-item-txt">
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-package-item">
								<img src="{{ $tournest }}/images/packages/p3.jpg" alt="package-place">
								<div class="single-package-item-txt">
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-package-item">
								<img src="{{ $tournest }}/images/packages/p4.jpg" alt="package-place">
								<div class="single-package-item-txt">
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-package-item">
								<img src="{{ $tournest }}/images/packages/p5.jpg" alt="package-place">
								<div class="single-package-item-txt">
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-package-item">
								<img src="{{ $tournest }}/images/packages/p6.jpg" alt="package-place">
								<div class="single-package-item-txt">
			...
			<div class="container">
				...
				<div class="owl-carousel owl-theme" id="testemonial-carousel">
					...
					<div class="home1-testm item">
						<div class="home1-testm-single text-center">
							<div class="home1-testm-img">
								<img src="{{ $tournest }}/images/client/testimonial1.jpg" alt="img"/>
							</div><!--/.home1-testm-img-->
					...
					<div class="home1-testm item">
						<div class="home1-testm-single text-center">
							<div class="home1-testm-img">
								<img src="{{ $tournest }}/images/client/testimonial2.jpg" alt="img"/>
							</div><!--/.home1-testm-img-->
							<div class="home1-testm-txt">
								<span class="icon section-icon">
									<i class="fa fa-quote-left" aria-hidden="true"></i>
						...
						<div class="col-sm-4">
							<div class="single-special-offer">
								<div class="single-special-offer-bg">
									<img src="{{ $tournest }}/images/offer/offer-shape.png" alt="offer-shape">
							...
							<div class="row">
								...
								<div class="col-sm-4 col-md-4">
									<div class="thumbnail">
										...
										<div class="thumbnail-img">
											<img src="{{ $tournest }}/images/blog/b1.jpg" alt="blog-img">
								...
								<div class="col-sm-4 col-md-4">
									<div class="thumbnail">
										<h2>trending news <span>15 november 2017</span></h2>
										<div class="thumbnail-img">
											<img src="{{ $tournest }}/images/blog/b2.jpg" alt="blog-img">
											<div class="thumbnail-img-overlay"></div><!--/.thumbnail-img-overlay-->
								...
								<div class="col-sm-4 col-md-4">
									<div class="thumbnail">
										<h2>trending news <span>15 november 2017</span></h2>
										<div class="thumbnail-img">
											<img src="{{ $tournest }}/images/blog/b3.jpg" alt="blog-img">
											<div class="thumbnail-img-overlay"></div><!--/.thumbnail-img-overlay-->
