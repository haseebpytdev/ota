...
{
    protected $signature = 'ota:prepare-duffel-test {--agency=asif-travels} {--keep-mock : Keep mock supplier active}';
    ...
    public function handle(): int
    {
        ...
        $mockUpdated = 0;
        if (! $this->option('keep-mock')) {
            $mockUpdated = SupplierConnection::query()
        ...
        $this->line("Mock suppliers deactivated: {$mockUpdated}");
